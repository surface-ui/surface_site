defmodule SurfaceSiteWeb.AppTest do
  ...
  test "disconnected and connected render", %{conn: conn} do
    ...
    assert disconnected_html =~ "A <strong>server-side rendering</strong> component library for <strong>Phoenix</strong>"
    ...
    assert disconnected_html =~ "Blog posts sharing relevant content related to <b>Surface</b> and <b>Liveview</b>"
    ...
    assert html =~ "Blog posts sharing relevant content related to <b>Surface</b> and <b>Liveview</b>"
  end
end
