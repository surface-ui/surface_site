          ...
          <div class="container column" style="background-color: #fff;">
            <div class="section" style="padding-bottom: 0px;">
              ...
              <div class="card dark">
                <footer class="card-footer">
                  <#Raw>
                    <div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Menlo, Monaco, &quot;Courier New&quot;, monospace; line-height: 26px; white-space: pre;"><br><div>  <span style="color: rgb(197, 134, 192);">defmodule</span> <span style="color: rgb(78, 201, 176);">Column</span> <span style="color: rgb(197, 134, 192);">do</span></div><div>    <span style="color: rgb(86, 156, 214);">use</span> <span style="color: rgb(156, 220, 254);">Surface</span>.<span style="color: rgb(156, 220, 254);">Component</span>, slot: <span style="color: rgb(206, 145, 120);">"cols"</span></div><br><div>    <span style="color: rgb(106, 153, 85);">@doc "The field to be rendered"</span></div><div>    <span style="color: rgb(78, 201, 176);">prop</span> <span style="color: rgb(156, 220, 254);">field</span>, :string</div><div>  <span style="color: rgb(197, 134, 192);">end</span></div><br><div>  <span style="color: rgb(197, 134, 192);">defmodule</span> <span style="color: rgb(78, 201, 176);">Grid</span> <span style="color: rgb(197, 134, 192);">do</span></div><div>    <span style="color: rgb(86, 156, 214);">use</span> <span style="color: rgb(156, 220, 254);">Surface</span>.<span style="color: rgb(156, 220, 254);">Component</span></div><br><div>    <span style="color: rgb(106, 153, 85);">@doc "The list of items to be rendered"</span></div><div>    <span style="color: rgb(78, 201, 176);">prop</span> <span style="color: rgb(156, 220, 254);">items</span>, :list, required: <span style="color: rgb(86, 156, 214);">true</span></div><br><div>    <span style="color: rgb(106, 153, 85);">@doc "The list of columns defining the Grid"</span></div><div>    <span style="color: rgb(78, 201, 176);">slot</span> <span style="color: rgb(156, 220, 254);">cols</span></div><br><div>    <span style="color: rgb(197, 134, 192);">def</span> <span style="color: rgb(220, 220, 170);">render</span>(assigns) <span style="color: rgb(197, 134, 192);">do</span></div><div>      <span style="color: rgb(206, 145, 120);">~H&quot;&quot;&quot;</span></div><div>      <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">table</span> <span style="color: rgb(156, 220, 254);">class</span>=<span style="color: rgb(206, 145, 120);">"table is-bordered is-striped is-hoverable is-fullwidth"</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">thead</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">tr</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">th</span> <span style="color: rgb(156, 220, 254);">:for</span>=<span style="color: rgb(86, 156, 214);">{{</span> col &lt;- <span style="color: rgb(156, 220, 254);">@cols</span> <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>              <span style="color: rgb(86, 156, 214);">{{</span> <span style="color: rgb(156, 220, 254);">Phoenix</span>.<span style="color: rgb(156, 220, 254);">Naming</span>.humanize(col.field) <span style="color: rgb(86, 156, 214);">}}</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">th</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">tr</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">thead</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">tbody</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">tr</span> <span style="color: rgb(156, 220, 254);">:for</span>=<span style="color: rgb(86, 156, 214);">{{</span> item &lt;- <span style="color: rgb(156, 220, 254);">@items</span> <span style="color: rgb(86, 156, 214);">}}</span> <span style="color: rgb(156, 220, 254);">class</span>=<span style="color: rgb(86, 156, 214);">{{</span> "has-text-warning": item[:selected] <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">td</span> <span style="color: rgb(156, 220, 254);">:for</span>=<span style="color: rgb(86, 156, 214);">{{</span> col &lt;- <span style="color: rgb(156, 220, 254);">@cols</span>, field = <span style="color: rgb(156, 220, 254);">String</span>.to_atom(col.field) <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>              <span style="color: rgb(86, 156, 214);">{{</span> item[field] <span style="color: rgb(86, 156, 214);">}}</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">td</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">tr</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">tbody</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>      <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">table</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>      <span style="color: rgb(206, 145, 120);">&quot;&quot;&quot;</span></div><div>    <span style="color: rgb(197, 134, 192);">end</span></div><div>  <span style="color: rgb(197, 134, 192);">end</span></div><br><div></div></div>
                  </#Raw>
                </footer>
              </div>
              ...
              <div class="card dark">
                <footer class="card-footer">
                  <#Raw>
                    <div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Menlo, Monaco, &quot;Courier New&quot;, monospace; font-size: 15px; line-height: 23px; white-space: pre;"><br><div>  <span style="color: rgb(197, 134, 192);">defmodule</span> <span style="color: rgb(78, 201, 176);">Column</span> <span style="color: rgb(197, 134, 192);">do</span></div><div>    <span style="color: rgb(86, 156, 214);">use</span> <span style="color: rgb(79, 193, 255);">Surface</span>.<span style="color: rgb(79, 193, 255);">Component</span>, slot: <span style="color: rgb(206, 145, 120);">"cols"</span></div><br><div>    <span style="color: rgb(106, 153, 85);">@doc "The title of the column"</span></div><div>    <span style="color: rgb(78, 201, 176);">prop</span> <span style="color: rgb(156, 220, 254);">title</span>, :string, required: <span style="color: rgb(86, 156, 214);">true</span></div><div>  <span style="color: rgb(197, 134, 192);">end</span></div><br><div>  <span style="color: rgb(197, 134, 192);">defmodule</span> <span style="color: rgb(78, 201, 176);">Grid</span> <span style="color: rgb(197, 134, 192);">do</span></div><div>    <span style="color: rgb(86, 156, 214);">use</span> <span style="color: rgb(79, 193, 255);">Surface</span>.<span style="color: rgb(79, 193, 255);">Component</span></div><br><div>    <span style="color: rgb(106, 153, 85);">@doc "The list of items to be rendered"</span></div><div>    <span style="color: rgb(78, 201, 176);">prop</span> <span style="color: rgb(156, 220, 254);">items</span>, :list, required: <span style="color: rgb(86, 156, 214);">true</span></div><br><div>    <span style="color: rgb(106, 153, 85);">@doc "The list of columns defining the Grid"</span></div><div>    <span style="color: rgb(78, 201, 176);">slot</span> <span style="color: rgb(156, 220, 254);">cols</span>, props: [item: ^items]</div><br><div>    <span style="color: rgb(197, 134, 192);">def</span> <span style="color: rgb(220, 220, 170);">render</span>(assigns) <span style="color: rgb(197, 134, 192);">do</span></div><div>      <span style="color: rgb(206, 145, 120);">~H&quot;&quot;&quot;</span></div><div>      <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">table</span> <span style="color: rgb(156, 220, 254);">class</span>=<span style="color: rgb(206, 145, 120);">"table is-bordered is-striped is-hoverable is-fullwidth"</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">thead</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">tr</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">th</span> <span style="color: rgb(156, 220, 254);">:for</span>=<span style="color: rgb(86, 156, 214);">{{</span> col &lt;- <span style="color: rgb(156, 220, 254);">@cols</span> <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>              <span style="color: rgb(86, 156, 214);">{{</span> col.title <span style="color: rgb(86, 156, 214);">}}</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">th</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">tr</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">thead</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">tbody</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">tr</span> <span style="color: rgb(156, 220, 254);">:for</span>=<span style="color: rgb(86, 156, 214);">{{</span> item &lt;- <span style="color: rgb(156, 220, 254);">@items</span> <span style="color: rgb(86, 156, 214);">}}</span> <span style="color: rgb(156, 220, 254);">class</span>=<span style="color: rgb(86, 156, 214);">{{</span> "is-selected": item[:selected] <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(86, 156, 214);">td</span> <span style="color: rgb(156, 220, 254);">:for.index</span>=<span style="color: rgb(86, 156, 214);">{{</span> <span style="color: rgb(156, 220, 254);">@cols</span> <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>              <span style="color: rgb(128, 128, 128);">&lt;</span><span style="color: rgb(78, 201, 176);">slot</span> <span style="color: rgb(156, 220, 254);">name</span>=<span style="color: rgb(206, 145, 120);">"cols"</span> <span style="color: rgb(156, 220, 254);">index</span>=<span style="color: rgb(86, 156, 214);">{{</span> index <span style="color: rgb(86, 156, 214);">}}</span> <span style="color: rgb(156, 220, 254);">:props</span>=<span style="color: rgb(86, 156, 214);">{{</span> item: item <span style="color: rgb(86, 156, 214);">}}</span><span style="color: rgb(128, 128, 128);">/&gt;</span></div><div>            <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">td</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>          <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">tr</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>        <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">tbody</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>      <span style="color: rgb(128, 128, 128);">&lt;/</span><span style="color: rgb(86, 156, 214);">table</span><span style="color: rgb(128, 128, 128);">&gt;</span></div><div>      <span style="color: rgb(206, 145, 120);">&quot;&quot;&quot;</span></div><div>    <span style="color: rgb(197, 134, 192);">end</span></div><div>  <span style="color: rgb(197, 134, 192);">end</span></div><br><div></div></div>
                  </#Raw>
                </footer>
              </div>
              ...
              <#Markdown>
                Let's take a closer look at two important changes we made in our `Grid`:
                  ...
                  1. `slot cols, props: [item: ^items]` - The `cols` slot now declares a slot prop `item`
                  ...
                  1. `<slot name="cols" index={{ index }} :props={{ item: item }}/>` - Here, we use `<slot>` to
                    render each column's content passing the current item.
              </#Markdown>
            </div>
